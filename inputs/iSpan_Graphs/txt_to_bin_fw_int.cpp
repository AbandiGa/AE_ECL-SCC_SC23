...
int main(int argc, char** argv){
	...
	std::string arg2 = argv[2];
        string c = arg2 + "fw_adjacent.bin";
	int fd4 = open( c.c_str(),O_CREAT|O_RDWR,00666 );
	...
	c = arg2 + "head.bin";
	int fd5 = open(c.c_str(),O_CREAT|O_RDWR,00666 );
	...
	c = arg2 + "out_degree.bin";
	int fd2 = open( c.c_str(),O_CREAT|O_RDWR,00666 );
	...
	c = arg2 + "fw_begin.bin";
	int fd3 = open( c.c_str(),O_CREAT|O_RDWR,00666 );
